...
INSERT INTO `products` (id, `description`, `name`, `price`, `quantity`, `quantity_sold`, `status`, `unit`, `brand_id`, `category_id`)
VALUES
(1, 'Product 1 description', 'Giay Nike', 1000, 50, 10, 'Active', 'Piece', 1, 1),
(2, 'Product 2 description', 'Sneaker Adidas', 750, 30, 5, 'Active', 'Piece', 2, 2),
(3, 'Product 3 description', 'Giay Nike Adidas', 500, 20, 8, 'Active', 'Piece', 1, 2),
(4, 'Product 4 description', 'Giay Nike Adidas', 500, 20, 8, 'Active', 'Piece', 1, 2),
(5, 'Product 5 description', 'Boots Puma', 500, 20, 8, 'Active', 'Piece', 3, 3),
(6, 'Product 6 description', 'Giay The Thao Fila', 500, 20, 8, 'Active', 'Piece', 4, 4),
(7, 'Product 7 description', 'Giay Cao Got Gucci', 500, 20, 8, 'Active', 'Piece', 5, 5);
...
VALUES 
	(1,'https://drive.google.com/file/d/11frR0urSnW_OqV-l-XwgdwcsO69CrfPm/view?usp=drive_link',1),
    (2,'https://drive.google.com/file/d/1aOfknC54qzFxNZ66HOiQ5XPqPgygD-Ye/view?usp=drive_link',1),
    (3,'https://drive.google.com/file/d/1v1-71xbxTw_EmisyEr0swudbfHj-IqY2/view?usp=drive_link',2);
